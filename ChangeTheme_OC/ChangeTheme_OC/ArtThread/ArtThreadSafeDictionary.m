...
@implementation ArtThreadSafeDictionary{
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:ArtThreadSafeDictionary.class]) {
        ArtThreadSafeDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:ArtThreadSafeDictionary.class]) {
        ArtThreadSafeDictionary *other = object;
        BOOL isEqual;
        dispatch_semaphore_wait(self->_lock, DISPATCH_TIME_FOREVER);
        dispatch_semaphore_wait(other->_lock, DISPATCH_TIME_FOREVER);
        isEqual = [_dic isEqual:other->_dic];
